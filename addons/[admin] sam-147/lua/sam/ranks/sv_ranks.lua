...
function sam.ranks.remove_rank(name)
	...
	// 16761ecd632b58591221e90dc7c15ee4341e10d4c9ad23f8cdfed2cb35621623
...
function sam.ranks.change_inherit(name, inherit)
	...
	-- b56e1ee7d2141d19a33bdca2a77b8fe35d4e1fb515ad18b32b87e412572a45c2!!!
...
function sam.ranks.change_immunity(name, new_immunity)
	...
	new_immunity = math.Clamp(new_immunity, 2, 99) // 90219818fa6304647184770be8735a2c328bfdbdb6305fdf4fb8b8f42e1aa795!!!
...
function sam.ranks.give_permission(name, permission)
	...
	-- c13cd8686cda10dd1e759e5e63ebc9dc3b42f8d0096e3ae29c705789e9694762!!!
...
hook.Add("SAM.DatabaseLoaded", "LoadRanks", function()
	SQL.Query([[
		...
		if #ranks < 3 then
			...
			/*5d1fc005a69d1d7b7fbb6984a9e4120cd20c61059d36f7303139e16aaf98d3db*/
		end
