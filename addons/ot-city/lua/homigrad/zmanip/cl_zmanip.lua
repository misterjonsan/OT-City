...
if hg.ZManipAnims.thump_up and not hg.ZManipAnims.thumb_up then
	hg.ZManipAnims.thumb_up = hg.ZManipAnims.thump_up
end
...
local mdl = Model("models/zmanip/c_zmanipinteract.mdl")
function hg.DoZManip(ent, ply)
	...
	for _, bone in ipairs(bones) do
		...
		bonepos.x = math.Clamp(bonepos.x, pos.x - 38, pos.x + 38)
