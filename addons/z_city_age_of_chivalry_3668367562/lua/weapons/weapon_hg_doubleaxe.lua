...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_doubleaxe.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_doubleaxe.mdl"
...
SWEP.HoldPos = Vector(-9,-8,3)
SWEP.HoldAng = Angle(3,2,21)
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_doubleaxe.png")
	SWEP.IconOverride = "entities/aoc_doubleaxe.png"
