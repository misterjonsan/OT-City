...
SWEP.PrintName = "shortsword"
SWEP.Instructions = ""
SWEP.Category = "Weapons - Age of Chivalry"
SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/weapons/ageofchivalry/w_shortsword.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_shortsword.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_shortsword.png")
	SWEP.IconOverride = "entities/aoc_shortsword.png"
