...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_warhammer.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_warhammer.mdl"
...
SWEP.HoldPos = Vector(-4,-7,6)
SWEP.HoldAng = Angle(17,-2,1)
...
SWEP.PenetrationSizePrimary = 34
SWEP.PenetrationSizeSecondary = 31.25
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_warhammer.png")
	SWEP.IconOverride = "entities/aoc_warhammer.png"
