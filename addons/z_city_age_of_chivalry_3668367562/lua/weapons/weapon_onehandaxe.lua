...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_throwable_axe.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_onehandaxe.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_onehandaxe.png")
	SWEP.IconOverride = "entities/aoc_onehandaxe.png"
