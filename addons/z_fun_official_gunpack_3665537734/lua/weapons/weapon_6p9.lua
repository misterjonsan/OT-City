...
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_pm.mdl"
SWEP.FakeScale = 1.15
...
SWEP.MagModel = "models/weapons/tfa_ins2/upgrades/a_magazine_pm_8.mdl"
...
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor4", Vector(0,0.07,0), {}},
		[2] = {"supressor3", Vector(0,0.2,-0.07), {}},
		[3] = {"supressor8", Vector(1.5,-0.4,-0.04), {}},
...
function SWEP:DrawPost()
	...
	if not IsValid(self.BMerge) then
		self:SetupBoneMerge("models/weapons/tfa_ins2/upgrades/a_magazine_pm_8.mdl")
	else
		self.BMerge:SetupBones()
		self.BMerge:DrawModel()
	end
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(42, Vector(0, 1.5 * self.shooanim, 0), false)
