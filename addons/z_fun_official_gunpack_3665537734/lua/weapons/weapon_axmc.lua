...
SWEP.PrintName = "AXMC"
SWEP.Author = "Mauser"
SWEP.Instructions = "The AXMC is the latest model in a long and distinguished line of battle-tested sniper rifles designed and manufactured by the British company Accuracy International. It is standardly chambered in .338 Lapua Magnum, but can be quickly converted to .300 Winchester Magnum and .308 Winchester calibers using a barrel, magazine, and bolt conversion kit."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_shot_m3super90.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_ai_axmc.mdl"
...
SWEP.AttachmentPos = Vector(-10,-0.6,0.3)
SWEP.AttachmentAng = Angle(0,0,0)

SWEP.FakeReloadSounds = {
	[0.41] = "weapons/tfa_nam_svd/svd_magout.wav",
	[0.89] = "weapons/tfa_nam_svd/svd_magin.wav",
}
...
SWEP.AnimsEvents = {
	["bolt1"] = {
		[0.1] = function(self)
			self:EmitSound("weapons/darsu_eft/axmc/aiax_bolt_out.ogg", 45, math_random(110, 115))
		end,
		[0.3] = function(self)
			...
			self:EmitSound("weapons/darsu_eft/axmc/aiax_bolt_in.ogg", 45, math_random(110, 115))
		end,
		[0.5] = function(self)
...
SWEP.Primary.Sound = {"weapons/darsu_eft/axmc/aiax_indoor_close.ogg", 65, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/axmc/aiax_indoor_silenced_close.ogg", 65, 90, 100}
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor8", Vector(12,-1.5,-0.3), {}},
		[2] = {"supressor6", Vector(3,0,0), {}},
		["mount"] = Vector(-3,2,0.2),
	},
	sight = {
		["mountType"] = {"picatinny", "dovetail","ironsight"},
		["mount"] = {["dovetail"] = Vector(-18.5, 2, 0),["picatinny"] = Vector(-18, 2.1, 0.02),["ironsight"] = Vector(-20, 2, -0.05)},
	},
	mount = {
		["dovetail"] = {
			"empty",
