...
SWEP.Instructions = "Suppressed Pistol chambered in .22 lr calibr."
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_pist_fiveseven.mdl"
SWEP.WorldModelFake = "models/weapons/nmrih/ruger/v_fa_mkiii.mdl"
...
SWEP.FakeEmptyReloadSounds = {
	[0.3] = "zcitysnd/sound/weapons/m9/handling/m9_magout.wav",
	[0.4] = "zcitysnd/sound/weapons/m9/handling/m9_magin.wav",
	[0.6] = "zcitysnd/sound/weapons/m9/handling/m9_maghit.wav",
	[0.87] = "zcitysnd/sound/weapons/m9/handling/m9_boltrelease.wav",
}
...
SWEP.AnimList = {
	["idle"] = "idle",
	["reload"] = "reload",
	["reload_empty"] = "reload_dry_maglite",
}




SWEP.WepSelectIcon2 = Material("materials/entities/arc9_nmrih_ruger.png")
SWEP.IconOverride = "materials/entities/arc9_nmrih_ruger.png"
...
SWEP.Primary.Sound = {"weapons/nmrih/ruger/mkiii_fire_01.wav", 65, 90, 100}
SWEP.Primary.SoundFP = {"weapons/nmrih/ruger/mkiii_fire_01.wav", 65, 90, 100}
...
SWEP.Primary.SoundEmpty = {"weapons/nmrih/ruger/mkiii_dryfire_01.wav", 75, 100, 105, CHAN_WEAPON, 2}
...
SWEP.WorldPos = Vector(2.5,-1.7,-2)
SWEP.WorldAng = Angle(0, -0.1, 0)
SWEP.UseCustomWorldModel = true
SWEP.attPos = Vector(2.7, 1, 26)
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(55,Vector(-0.6*self.shooanim ,0 ,0 ),false)
