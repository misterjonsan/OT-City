...
SWEP.PrintName = "Sako TRG"
SWEP.Author = "SAKO Ltd"
SWEP.Instructions = "Sako TRG M10 is a high-precision bolt-action sniper rifle chambered for the .338 Lapua Magnum cartridge. The TRG M10 is an extremely versatile platform that can be easily converted from a full-size long-range rifle to a more compact weapon. It is designed for use by military, police, and special forces units in various countries. The rifle is manufactured by Sako, a subsidiary of Beretta Defense Technologies."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_shot_m3super90.mdl"
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_sako_trg.mdl"
SWEP.FakeAttachment = "1"
SWEP.FakeBodyGroups = "1111111111111"
...
SWEP.AttachmentPos = Vector(-5,-0.6,0.3)
...
SWEP.AnimsEvents = {
	["bolt1"] = {
		[0.1] = function(self)
			self:EmitSound("weapons/darsu_eft/sako/sako_bolt_out.ogg", 45, math_random(110, 115))
		end,
		[0.3] = function(self)
			...
			self:EmitSound("weapons/darsu_eft/sako/sako_bolt_in.ogg", 45, math_random(110, 115))
		end,
		[0.5] = function(self)
...
SWEP.Primary.Sound = {"weapons/darsu_eft/sako/sako_fire_indoor_close.ogg", 65, 90, 100}
SWEP.SupressedSound = {"weapons/darsu_eft/sako/sako_fire_indoor_silenced_close.ogg", 65, 90, 100}
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor8", Vector(6,-1.5,-0.3), {}},
		[2] = {"supressor6", Vector(3,0,0), {}},
		["mount"] = Vector(-3,2,0.2),
	},
	sight = {
		["mountType"] = {"picatinny", "dovetail","ironsight"},
		["mount"] = {["dovetail"] = Vector(-18.5, 2, 0),["picatinny"] = Vector(-18, 2.1, 0.02),["ironsight"] = Vector(-17, 2, -0.05)},
	},
	mount = {
		["dovetail"] = {
			"empty",
...
SWEP.LocalMuzzlePos = Vector(28,-0.022,2.758)
...
SWEP.DistSound = "weapons/darsu_eft/sako/sako_fire_indoor_distant.ogg"
