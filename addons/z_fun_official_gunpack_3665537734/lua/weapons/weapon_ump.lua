...
SWEP.PrintName = "HK UMP .45 ACP"
SWEP.Author = "Heckler & Koch"
SWEP.Instructions = "Heckler & Koch UMP is a director-producer, redesigned by the German company Heckler & Koch in 1990 as a lighter and more effective alternative to the MP5. This variant is designed to fire the .45 ACP cartridge and can handle up to 600 rounds per minute."
SWEP.Category = "Weapons - Machine-Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_asval.mdl"
SWEP.WorldModelFake = "models/weapons/arc_eft_ump/eft_ump/models/c_eft_ump.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(-10.5, 4, 8.35)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(12,0,1)
...
SWEP.FakeReloadSounds = {
	[0.32] = "weapons/arccw_eft/ump/mp5_weap_mag_out.wav",
	[0.8] = "weapons/arccw_eft/ump/mp5_weap_mag_in.wav",
}
SWEP.DOZVUK = true

SWEP.FakeEmptyReloadSounds = {
	[0.3] = "weapons/arccw_eft/ump/mp5_weap_mag_out.wav",
	[0.65] = "weapons/arccw_eft/ump/mp5_weap_mag_in.wav",
	[0.92] = "weapons/arccw_eft/ump/mp5_weap_mag_release_button.wav",
	[0.97] = "weapons/arccw_eft/ump/mp5_weap_bolt_in_slap.wav"
}
...
SWEP.WepSelectIcon2 = Material("entities/arccw_eft_ump.png")
SWEP.IconOverride = "entities/arccw_eft_ump.png"
...
SWEP.Primary.Sound = {"weapons/arccw_eft/ump/gyrza_close1.wav", 65, 90, 100}
SWEP.SupressedSound = {"m14/m14_suppressed_fp.wav", 65, 90, 100}
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, 0.4, 6.6)
SWEP.RHandPos = Vector(-5, -1, 1)
SWEP.LHandPos = Vector(7, -2, -2)
SWEP.ShockMultiplier = 3
SWEP.CustomShell = "9x19"
SWEP.EjectPos = Vector(4,15,-4)
SWEP.EjectAng = Angle(0,-90,90)
...
SWEP.availableAttachments = {
	...
	mount = {
		...
		["mount"] = Vector(-12.5,0,0),
	},
	underbarrel = {
		["mount"] = Vector(-2, -1.5, -1),
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		wep:ManipulateBonePosition(13,vec,false)
	end
end
