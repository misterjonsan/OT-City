...
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_vsk94.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
--а еще надо настраивать заново zoompos
SWEP.FakePos = Vector(-10.5, 2.8, 8)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(35,-2,-1)
...
SWEP.LocalMuzzlePos = Vector(28,-1.3,5)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -1.49, 6.5)
...
SWEP.availableAttachments = {
	sight = {
		...
		["mount"] = { dovetail = Vector(-45, 3, -2), picatinny = Vector(-44,3.5,-2)}
	},
	mount = {
		["picatinny"] = {
			"mount3",
