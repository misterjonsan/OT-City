...
local function IsSoftSurface(trace)
    ...
    local texture = string.lower(trace.HitTexture or "")
    ...
    /*if matType == MAT_DIRT or 
       ...
       matType == MAT_FLESH or
       matType == MAT_FOLIAGE then
        return true
    end
    
    if texture:find("dirt") or 
       texture:find("mud") or
       texture:find("sand") or
       texture:find("grass") or
       texture:find("snow") or
       texture:find("gravel") or
       texture:find("ground") then
        return true
    end*/
