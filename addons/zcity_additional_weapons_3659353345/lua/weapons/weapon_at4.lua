...
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/tfa_ins2_wpns/at4/w_at4.mdl"
...
SWEP.podkid = 1
--local to head
SWEP.RHPos = Vector(12,-6,7)
SWEP.RHAng = Angle(0,0,90)
--local to rh
SWEP.LHPos = Vector(-5,1,-3)
SWEP.LHAng = Angle(20,70,-100)
