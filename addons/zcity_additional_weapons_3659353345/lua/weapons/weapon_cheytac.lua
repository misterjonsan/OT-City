...
SWEP.Author = "Manufactured by CheyTac USA."
SWEP.Instructions = "Heavy sniper rifle chambered in .408 CheyTac.\nDesigned for extreme long-range shooting with very high power."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/w_svd.mdl"
SWEP.WorldModelFake = "models/weapons/cheytac/c_ins2_warface_cheytac_m200_2.mdl"
SWEP.FakeAttachment = "muzzle"

SWEP.FakePos = Vector(-12, 3.7, 6.7)
SWEP.FakeAng = Angle(-0.2, 0, 0)
SWEP.AttachmentPos = Vector(1.5,0.4,0.5)
SWEP.AttachmentAng = Angle(0,0,0)

SWEP.FakeReloadSounds = {
	[0.28] = "weapons/cheytac_m200/m200_magrelease.wav",
	[0.41] = "weapons/cheytac_m200/m200_clipout.wav",
	[0.8] = "weapons/cheytac_m200/m200_clipin.wav",
	[0.95] = "weapons/cheytac_m200/m200_draw.wav",
}
...
SWEP.AnimsEvents = {
	["base_fire_end"] = {
		...
		[0.5] = function(self)
			self:EmitSound("weapons/cheytac_m200/m200_boltforward.wav", 45, math_random(110, 115))
		end,
		[0.6] = function(self)
...
SWEP.RestPosition = Vector(26, 0, 7)
SWEP.BipodOffset = Vector(9, -4, 2)

SWEP.ScrappersSlot = "Primary"
SWEP.WepSelectIcon2 = Material("entities/tfa_ins2_warface_cheytac_m200_1.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/tfa_ins2_warface_cheytac_m200_1.png"
SWEP.weight = 8
SWEP.weaponInvCategory = 1
SWEP.CustomShell = ".408cheytac"
...
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor9", Vector(-5, 0, 0), {}},
		[2] = {"supressor11", Vector(-5, 0, 0), {}},
	},
	sight = {
		["mountType"] = {"picatinny", "ironsight"},
		["mount"] = {picatinny = Vector(-39.2, 1.1, -0.2)}
	},
}

SWEP.StartAtt = {"optic17"}

SWEP.addSprayMul = 1
SWEP.cameraShakeMul = 1
SWEP.RecoilMul = 2

SWEP.LocalMuzzlePos = Vector(41.8,0.25,2.45)
...
SWEP.holsteredPos = Vector(8, 8, -8)
...
function SWEP:Reload(time)
	...
	if self.drawBullet == false and SERVER then
		...
		self:PlayAnim(self.AnimList["cycle"] or "cycle", 2.5, false, nil, false, true)
		return
	end
