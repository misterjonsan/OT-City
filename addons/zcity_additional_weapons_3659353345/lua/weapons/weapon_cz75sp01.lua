...
SWEP.PrintName = "ČZ 75 SP01"
SWEP.Author = "Manufactured by Česká Zbrojovka in the Czech Republic."
SWEP.Instructions = "Semi-automatic pistol chambered in 9×19mm.\nReliable handgun with good accuracy and manageable recoil."
SWEP.Category = "Weapons - Pistols"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/w_pist_p228.mdl"
SWEP.WorldModelFake = "models/weapons/cz75sp01/c_pist_cz75bsp01.mdl"

SWEP.FakePos = Vector(-24, 2.9, 8.65)
SWEP.FakeAng = Angle(0, 0, 0)
SWEP.AttachmentPos = Vector(-1.8,-0.11,0.9)
SWEP.AttachmentAng = Angle(0,1,90)
SWEP.MagIndex = 53
...
SWEP.ZoomPos = Vector(-30, 0.8, 8.1)
...
SWEP.availableAttachments = {
	...
	underbarrel = {
		["mount"] = Vector(13.5, -1.8, -1),
		["mountAngle"] = Angle(0.155, -1.8, 90),
		["mountType"] = "picatinny_small"
	},
}

SWEP.LocalMuzzlePos = Vector(-0.9,0.81,7.5)
SWEP.LocalMuzzleAng = Angle(1,-0.002,0)
