...
SWEP.Instructions = "Battle rifle chambered in 7.62×51mm NATO.\nPowerful and reliable rifle widely used during the Cold War."
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/akpack/w_akm.mdl"
SWEP.WorldModelFake = "models/weapons/fnfal/c_ins2_fn_fal.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-7, 2.2, 4.5)
SWEP.FakeAng = Angle(0, 0, -0)
SWEP.AttachmentPos = Vector(1.97,2.78,-27.05)
...
SWEP.FakeReloadSounds = {
	[0.35] = "weapons/fal/fnfal_magout.wav",
	[0.87] = "weapons/fal/fnfal_magin.wav",

}

SWEP.FakeEmptyReloadSounds = {
	[0.3] = "weapons/fal/fnfal_magout.wav",
	[0.67] = "weapons/fal/fnfal_magin.wav", --ееее сикс севен!
	[0.87] = "weapons/fal/fnfal_boltback.wav",
	[0.95] = "weapons/fal/fnfal_boltrelease.wav",
}
...
SWEP.Primary.Sound = {"weapons/fal/fnfal_fire.wav", 85, 90, 100}
...
SWEP.WepSelectIcon2 = Material("entities/tfa_ins2_fn_fal.png")
SWEP.IconOverride = "entities/tfa_ins2_fn_fal_2.png"
SWEP.ScrappersSlot = "Primary"
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor6", Vector(0,0,0), {}},
		[2] = {"supressor7", Vector(0,0,0), {}},
		["mount"] = Vector(-2,-0.1,0),
		["mountAngle"] = {["picatinny"] = Angle(0, 1.5, 0)},
	},
	sight = {
		["mount"] = {picatinny = Vector(-26, 1.6, 0.08)},
		["mountType"] = {"picatinny"},
		["empty"] = {
			"empty",
		},
...
SWEP.LocalMuzzlePos = Vector(29.1,-0.25,2.25)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.28, 4.3)
