...
zb.Points.HMCD_SO2_T = zb.Points.HMCD_SO2_T or {}
zb.Points.HMCD_SO2_T.Color = Color(185, 60, 60)
zb.Points.HMCD_SO2_T.Name = "HMCD_SO2_T"

zb.Points.HMCD_SO2_CT = zb.Points.HMCD_SO2_CT or {}
zb.Points.HMCD_SO2_CT.Color = Color(60, 140, 255)
zb.Points.HMCD_SO2_CT.Name = "HMCD_SO2_CT"

zb.Points.HMCD_SO2_GRT = zb.Points.HMCD_SO2_GRT or {}
zb.Points.HMCD_SO2_GRT.Color = Color(120, 120, 255)
zb.Points.HMCD_SO2_GRT.Name = "HMCD_SO2_GRT"

zb.Points.HMCD_SO2_CAPPOINT = zb.Points.HMCD_SO2_CAPPOINT or {}
zb.Points.HMCD_SO2_CAPPOINT.Color = Color(160, 160, 160)
zb.Points.HMCD_SO2_CAPPOINT.Name = "HMCD_SO2_CAPPOINT"
...
function MODE:HG_MovementCalc_2(mul, ply, cmd, mv)
	if (zb.ROUND_START or 0) + 20 > CurTime() and IsValid(ply) and ply:Alive() and ply:Team() ~= 2 then
		if cmd then
...
function MODE:PlayerCanLegAttack(ply)
	if zb.CROUND == "standoff_2" and (zb.ROUND_START or 0) + 20 > CurTime() and IsValid(ply) and ply:Team() ~= 2 then
		return false
	end
end