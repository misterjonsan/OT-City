...
hook.Add("PopulateToolMenu","error_fixer_tool",function()
	...
	spawnmenu.AddToolMenuOption("Main","error_fixers","lua_error_fixer","Lua Error Fixer","","",function(DForm)
		...
		If you're a player, this addon might generate strange errors or bug out your game while enabled! \z
		If another addon is broken, turn this addon off, then see if your errors persist!")
