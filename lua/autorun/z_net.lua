...
function netstream.GetStored()
    return netstream.stored;
end;
...
hook.Add("InitPostEntity", "netstreams", function()
    print("NESTREAMS----------------------------------------------")
    hook.Run("netstreamready")
    timer.Simple(15, function()
        print("NESTREAMS----------------------------------------------RUN INITIALIZE")
        hook.Run("netstreamready")
    end)
end)

hook.Add("netstreamready", "MilkyNetStream", function()
    print("MLIB - NETSTREAM READY ----------------------------------")
end)
