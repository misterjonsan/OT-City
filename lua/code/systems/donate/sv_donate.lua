...
OTCDonate.Config = OTCDonate.Config or {
    ...
    apiKey = "MILKABIRKA22324562812919212313199293918774929284",
    apiURL = "https://monteract.ru/rukassa/",
    discordWebhook = "",
    rubToBalance = 1,
    ...
    adminCostumePanelURL = "https://monteract.myarena.site/mlogs/api.php",
    otcCoinShop = {
        minAmount = 100,
        maxAmount = 10000,
        step = 50,
