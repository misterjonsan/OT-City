hg.HeadshotSound2D = "milky/head.mp3"

local hg_headshotsound = ConVarExists("hg_headshotsound") and GetConVar("hg_headshotsound") or CreateClientConVar("hg_headshotsound", "1", true, false, "headshot hit sound", 0, 1)

net.Receive("hg headshot sound", function()
	local snd = hg.HeadshotSound2D

	if not snd or snd == "" then return end
	if not hg_headshotsound:GetBool() then return end
