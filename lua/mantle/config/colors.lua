...
-- моя палитра
Mantle.color_coffee = {
    header = Color(200, 80, 140),
    header_text = Color(255, 255, 255),

    background = Color(55, 20, 40),
    background_alpha = Color(55, 20, 40, 215),
    background_panelpopup = Color(70, 25, 50, 150),

    button = Color(220, 90, 160),
    button_shadow = Color(40, 10, 30, 40),
    button_hovered = Color(235, 110, 175),

    category = Color(190, 70, 135),
    category_opened = Color(190, 70, 135, 0),

    theme = Color(230, 95, 165),
    ...
    toggle = Color(120, 40, 90),

    focus_panel = Color(180, 70, 130, 200),
    hover = Color(230, 95, 165, 90),

    window_shadow = Color(25, 5, 20, 100),

    gray = Color(255, 170, 210, 200),
    text = Color(255, 255, 255)
}
