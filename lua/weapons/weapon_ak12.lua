...
SWEP.Author = "Manufactured by the Kalashnikov Concern in Russia."
SWEP.Instructions = "Assault rifle chambered in 5.45×39mm.\nModern Russian service rifle with good accuracy and controllable recoil."
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/ak400/w_ak400.mdl"
SWEP.WorldModelFake = "models/weapons/ak400/c_ak400.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-8, 3.53, 6.3)
SWEP.FakeAng = Angle(-1, 0, -1)
SWEP.AttachmentPos = Vector(3.8,2.1,-27.8)
SWEP.AttachmentAng = Angle(1,0,90)
SWEP.FakeAttachment = "muzzle"
SWEP.FakeBodyGroups = "079000403210000"
SWEP.ZoomPos = Vector(0, 0.03, 5.11)
...
SWEP.LocalMuzzlePos = Vector(27,-0.03,3)
SWEP.LocalMuzzleAng = Angle(-0.9,-0.1,0)
...
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"picatinny"},
		["mount"] = {["picatinny"] = Vector(-26, 1.1, -0.12)},
	},
	barrel = {
		[1] = {"supressor1", Vector(0,0.6,0.1), {}},
		[2] = {"supressor8", Vector(0,0,0), {}},
		["mount"] = Vector(-8,-0.5,-0.09),
		["mountAngle"] = Angle(0,2,0)
	},
	grip = {
		["mount"] = { ["picatinny"] = Vector(-2,0.6,0.1) },
		["mountType"] = {"picatinny"}
	},
}
