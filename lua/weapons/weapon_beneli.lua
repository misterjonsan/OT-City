...
SWEP.PrintName = "Benelli M3 Super 90 12K"
SWEP.Author = "Benelli"
...
SWEP.WorldModelFake = "models/weapons/arc9/darsu_eft/c_m3super90.mdl"

SWEP.FakePos = Vector(-12, 4, 7.5)
SWEP.FakeAng = Angle(-0.5, 0, 1)
SWEP.AttachmentPos = Vector(40,-2,4)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(0, -0.26, 6.9)
...
SWEP.availableAttachments = {
	barrel = {
		[1] = {"supressor5", Vector(-40,-4,-2.2), {}},
	},
	sight = {
		["mountType"] = "picatinny",
		["mount"] = Vector(-62, -3, -2.2),
	},
}
