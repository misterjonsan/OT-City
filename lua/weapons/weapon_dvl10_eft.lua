...
SWEP.Author = "Manufactured by Lobaev Arms in Russia."
SWEP.Instructions = "Bolt-action sniper rifle chambered in .308 Winchester (7.62×51mm).\nHigh precision rifle designed for quiet and accurate long-range shooting."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/w_svd.mdl"
SWEP.WorldModelFake = "models/weapons/dvl10/c_dvl10.mdl"
...
SWEP.FakePos = Vector(-14, 4.5, 7)
SWEP.FakeAng = Angle(-0.2, 0, 0)
SWEP.AttachmentPos = Vector(-7.3,0.3,0.3)
...
SWEP.Primary.Sound = {"weapons/dvl10/dvl_fire_silenced_close.ogg", 65, 90, 100}
SWEP.SupressedSound = {"weapons/dvl10/dvl_fire_silenced_close.ogg", 65, 90, 100}
SWEP.availableAttachments = {
	sight = {
		["mountType"] = {"picatinny", "ironsight"},
		["mount"] = {ironsight = Vector(-27.5, 1.4, 0.05), picatinny = Vector(-25, 1.4, 0.05)}
	},
}
...
SWEP.LocalMuzzlePos = Vector(30.5,0.3,3.958)
