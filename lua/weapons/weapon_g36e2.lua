...
SWEP.WorldModelFake = "models/weapons/g36e2/c_g36.mdl"

SWEP.FakePos = Vector(-15, 3.81, 6)
SWEP.FakeAng = Angle(0, 0, 0.1)
SWEP.AttachmentPos = Vector(9.5,2.1,-28)
...
SWEP.availableAttachments = {
	barrel = {
		...
		["mount"] = Vector(-0.7,0.4,0.17),
		["mountAngle"] = {["picatinny"] = Angle(0, 0, 0)},
	},
	sight = {
		["mount"] = {picatinny = Vector(-22, 2.81, 0.05)},
		["mountType"] = {"picatinny"},
		["empty"] = {
			"empty",
		},
	...
	grip = {
		["mount"] = { ["picatinny"] = Vector(3,0.2,0.2) },
		["mountType"] = {"picatinny"},
...
SWEP.LocalMuzzlePos = Vector(25.5,-0.39,1.895)
