...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_flamberge.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_flamberge.mdl"
...
SWEP.HoldPos = Vector(-14,3,-1)
SWEP.HoldAng = Angle(0,2,-5)
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_flamberge.png")
	SWEP.IconOverride = "entities/aoc_flamberge.png"
