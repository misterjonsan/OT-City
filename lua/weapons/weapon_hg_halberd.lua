...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_halberd2.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_halberd_evil.mdl"
...
SWEP.HoldPos = Vector(-2,-5,6)
SWEP.HoldAng = Angle(8,-12,1)
...
SWEP.PenetrationSizePrimary = 14
SWEP.PenetrationSizeSecondary = 11.25
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_halberd_evil.png")
	SWEP.IconOverride = "entities/aoc_halberd_evil.png"
