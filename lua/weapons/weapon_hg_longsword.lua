...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_longsword.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_longsword.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_longsword.png")
	SWEP.IconOverride = "entities/aoc_longsword.png"
