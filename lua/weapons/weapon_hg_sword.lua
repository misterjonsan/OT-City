...
SWEP.WorldModel = "models/weapons/ageofchivalry/w_sword_iron.mdl"
SWEP.WorldModelReal = "models/weapons/ageofchivalry/c_sword_iron.mdl"
...
if CLIENT then
	SWEP.WepSelectIcon = Material("entities/aoc_sword_iron.png")
	SWEP.IconOverride = "entities/aoc_sword_iron.png"
