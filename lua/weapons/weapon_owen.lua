...
SWEP.WorldModelFake = "models/weapons/owen/c_owen.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-12, 2.5, 6.8)
SWEP.FakeAng = Angle(0.5, -0.6, 5)
...
SWEP.LocalMuzzlePos = Vector(21,-1.5,1.3)
SWEP.LocalMuzzleAng = Angle(1,-1.6,0)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-1, -2.32, 2.6)
...
SWEP.Ergonomics = 1
SWEP.Penetration = 7
SWEP.WorldPos = Vector(3, -2, -3)
SWEP.WorldAng = Angle(0, 0, -10)
