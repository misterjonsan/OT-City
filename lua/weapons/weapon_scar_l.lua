...
SWEP.Author = "FNH USA Inc"
SWEP.Instructions = "English. Special Operations Forces Combat Assault Rifle — This gun chambered in 5.56x45 caliber"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/akpack/w_ak74.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/c_mw3e_scarl.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ ЭЭЭ ДА НОРМ ВСЕ ЧЕ ВЫ
--PrintBones(Entity(1):GetActiveWeapon():GetWM())
--uncomment for funny
SWEP.FakePos = Vector(-9, 1.3, 5.3)
...
SWEP.Primary.Sound = {"weapons/fesiugmw2/fire/scar.wav", 75, 120, 140}
...
SWEP.ReloadSoundes = {
	"none",
	"none",
	"weapons/m4a1/m4a1_magout.wav",
	"none",
	"weapons/m4a1/m4a1_magain.wav",
	"weapons/m4a1/m4a1_hit.wav",
	"weapons/m4a1/m4a1_boltarelease.wav",
	"none",
	"none",
	"none"
}
...
SWEP.LocalMuzzlePos = Vector(15.985,-1.4,2.2)
...
SWEP.Ergonomics = 1
SWEP.WorldPos = Vector(6, -2.8, -1.1)
...
SWEP.availableAttachments = {
	...
	underbarrel = {
		["mount"] = {["picatinny_small"] = Vector(-5, 2.2, -1.45),["picatinny"] = Vector(3,0,-2)},
		["mountAngle"] = {["picatinny_small"] = Angle(-1, -0.3, -90),["picatinny"] = Angle(0, 0, 90)},
...
function SWEP:DrawPost()
	...
	if CLIENT and IsValid(wep) then
		...
		vec[1] = -1.5*self.shooanim
		vec[2] = 0*self.shooanim
		vec[3] = 0*self.shooanim
		wep:ManipulateBonePosition(95,vec,false)
	end
end
