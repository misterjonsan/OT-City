...
SWEP.PrintName = "SV98"
SWEP.Author = "Manufactured by Izhmash in Russia."
SWEP.Instructions = "Bolt-action sniper rifle chambered in 7.62×54mmR.\nMilitary precision rifle used for long-range engagements."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/w_svd.mdl"
SWEP.WorldModelFake = "models/weapons/sv98/c_sv98.mdl"
...
SWEP.AnimsEvents = {
	["bolt1"] = {
		[0.2] = function(self)
			self:EmitSound("weapons/sv98/sv98_boltout.ogg", 45, math_random(110, 115))
		end,
		[0.49] = function(self)
			self:EmitSound("weapons/sv98/sv98_boltin.ogg", 45, math_random(110, 115))
		end,
    }
}
...
SWEP.Primary.Sound = {"weapons/sv98/sv98_fire_close.ogg", 65, 90, 100}
SWEP.SupressedSound = {"weapons/sv98/sv98_fire_silenced_close.ogg", 65, 90, 100}
SWEP.availableAttachments = {
	...
	sight = {
		...
		["mount"] = {picatinny = Vector(-29.5, 0.7, 0.05)}
	},
}

SWEP.StartAtt = {"optic14"}

SWEP.addSprayMul = 1
SWEP.cameraShakeMul = 1
SWEP.RecoilMul = 0.7

SWEP.LocalMuzzlePos = Vector(32.7,0.42,4.9)
...
SWEP.HoldType = "rpg"
SWEP.ZoomPos = Vector(-3, 0.41, 5.96)
...
SWEP.DistSound = "weapons/sv98/sv98_fire_distant.ogg"
