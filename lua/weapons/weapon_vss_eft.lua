...
SWEP.PrintName = "VSS EFT"
SWEP.Author = "Developed by TsNIITochMash for Soviet special forces."
SWEP.Instructions = "Suppressed sniper rifle chambered in 9×39mm.\nBuilt-in suppressor and high precision make it effective for stealth operations."
SWEP.Category = "Weapons - Sniper Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/zcity/w_asval.mdl"
SWEP.WorldModelFake = "models/weapons/vss/c_vss.mdl" -- Контент инсурги https://steamcommunity.com/sharedfiles/filedetails/?id=3437590840 
--uncomment for funny
...
SWEP.availableAttachments = {
	sight = {
		...
		["mount"] = { dovetail = Vector(-19, 2, 0), picatinny = Vector(-23.5,2.65,0.05)}
	},
	mount = {
		["picatinny"] = {
			"mount3",
